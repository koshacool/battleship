...
/* harmony import */ var _notifierConfig__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./notifierConfig */ "./src/app/notifierConfig.ts");
...
/* harmony import */ var _public_public_pages_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./public/public-pages.module */ "./src/app/public/public-pages.module.ts");
/* harmony import */ var _protected_protected_pages_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./protected/protected-pages.module */ "./src/app/protected/protected-pages.module.ts");
...
var metaReducers = _environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].production ? [] : [logger];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _ngrx_store__WEBPACK_IMPORTED_MODULE_8__["StoreModule"].forRoot(_store_app_reducers__WEBPACK_IMPORTED_MODULE_21__["reducers"], { metaReducers: metaReducers }),
                angular_notifier__WEBPACK_IMPORTED_MODULE_7__["NotifierModule"].withConfig(_notifierConfig__WEBPACK_IMPORTED_MODULE_12__["customNotifierOptions"]),
                _shared_shared_module__WEBPACK_IMPORTED_MODULE_15__["SharedModule"],
                _protected_protected_pages_module__WEBPACK_IMPORTED_MODULE_17__["ProtectedPagesModule"],
                _public_public_pages_module__WEBPACK_IMPORTED_MODULE_16__["PublicPagesModule"],
...
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./routes */ "./src/app/constants/routes.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_board__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/board */ "./src/app/shared/board.ts");
...
var BoardService = /** @class */ (function () {
    ...
    BoardService.prototype.createBoard = function (playerId) {
        var tiles = [];
        // create tiles for board
        for (var i = 0; i < _constants__WEBPACK_IMPORTED_MODULE_3__["BOARD_SIZE"]; i++) {
            tiles[i] = [];
            for (var j = 0; j < _constants__WEBPACK_IMPORTED_MODULE_3__["BOARD_SIZE"]; j++) {
                tiles[i][j] = { used: false, value: 0, status: '' };
            }
        }
        // generate random ships for the board
        for (var i = 0; i < _constants__WEBPACK_IMPORTED_MODULE_3__["BOARD_SIZE"]; i++) {
            tiles = this.randomShips(tiles, _constants__WEBPACK_IMPORTED_MODULE_3__["BOARD_SIZE"]);
        }
        // create board
        var board = new _shared_board__WEBPACK_IMPORTED_MODULE_2__["Board"]({
            playerId: playerId,
            score: 0,
            tiles: tiles,
        });
...
/***/ "./src/app/protected/game.service.ts":
/*!*******************************************!*\
  !*** ./src/app/protected/game.service.ts ***!
  \*******************************************/
...
/* harmony import */ var _board_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./board.service */ "./src/app/protected/board.service.ts");
/* harmony import */ var _shared_game__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/game */ "./src/app/shared/game.ts");
...
var GameService = /** @class */ (function () {
    function GameService(boardService, db, router) {
        this.boardService = boardService;
        this.db = db;
        this.router = router;
        this.gameRef = this.db.list('games');
    }
    GameService.prototype.restoreGame = function (game) {
        this.game = game;
    };
    GameService.prototype.createGame = function (userId) {
        var _this = this;
        var playerBoard = this.boardService.createBoard(userId);
        var computerBoard = this.boardService.createBoard('1');
        var newGame = new _shared_game__WEBPACK_IMPORTED_MODULE_6__["Game"]({
            status: _constants__WEBPACK_IMPORTED_MODULE_7__["GAME_STATUSES"].notEnded,
            date: moment__WEBPACK_IMPORTED_MODULE_4__().format(),
            turn: userId,
            userId: userId,
            boards: [
                computerBoard,
        ...
        this.gameRef
            .push(newGame)
            .then(function (res) { return _this.router.navigate(['/games', res.key]); });
    };
    GameService.prototype.updateGame = function () {
        var _a = this.game, key = _a.key, game = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](_a, ["key"]);
    ...
    GameService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_board_service__WEBPACK_IMPORTED_MODULE_5__["BoardService"],
...
/***/ "./src/app/protected/games/game/game.component.css":
/*!*********************************************************!*\
  !*** ./src/app/protected/games/game/game.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/app/protected/games/game/game.component.html":
/*!**********************************************************!*\
  !*** ./src/app/protected/games/game/game.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/protected/games/game/game.component.ts":
/*!********************************************************!*\
  !*** ./src/app/protected/games/game/game.component.ts ***!
  \********************************************************/
...
var GameComponent = /** @class */ (function () {
    function GameComponent(store, notifierService, route, gameService) {
        var _this = this;
        this.store = store;
        this.notifierService = notifierService;
        this.route = route;
    ...
    GameComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (_a) {
            ...
            _this.store.select('games').subscribe(function (_a) {
                var games = _a.games;
                var gameFromServer = games.find(function (_a) {
                    var key = _a.key;
                    return key === id;
                });
    ...
    GameComponent.prototype.fire = function (e) {
        ...
        var board = this.boards.find(function (_a) {
            ...
            return playerId === boardId;
        });
        var playerBoard = this.boards.find(function (_a) {
            var playerId = _a.playerId;
            return playerId !== '1';
        });
        var tile = board.tiles[row][col];
        var error = this.checkValidHit(board, tile);
        if (error) {
            this.notifierService.show({
                message: error,
                type: 'error',
    ...
    GameComponent.prototype.enemyTurn = function () {
        ...
        var computerBoard = this.boards.find(function (_a) {
            var playerId = _a.playerId;
            return playerId === '1';
        });
    ...
    GameComponent.prototype.isPlayerTurn = function () {
    ...
    GameComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-game',
            template: __webpack_require__(/*! ./game.component.html */ "./src/app/protected/games/game/game.component.html"),
            styles: [__webpack_require__(/*! ./game.component.css */ "./src/app/protected/games/game/game.component.css")]
        }),
...
/***/ "./src/app/protected/games/games-list/games-list.component.css":
/*!*********************************************************************!*\
  !*** ./src/app/protected/games/games-list/games-list.component.css ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/protected/games/games-list/games-list.component.html":
/*!**********************************************************************!*\
  !*** ./src/app/protected/games/games-list/games-list.component.html ***!
  \**********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/protected/games/games-list/games-list.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/protected/games/games-list/games-list.component.ts ***!
  \********************************************************************/
...
var GamesListComponent = /** @class */ (function () {
    ...
    GamesListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./games-list.component.html */ "./src/app/protected/games/games-list/games-list.component.html"),
            styles: [__webpack_require__(/*! ./games-list.component.css */ "./src/app/protected/games/games-list/games-list.component.css")]
        }),
...
/***/ "./src/app/protected/games/games.component.css":
/*!*****************************************************!*\
  !*** ./src/app/protected/games/games.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Byb3RlY3RlZC9nYW1lcy9nYW1lcy5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/protected/games/games.component.html":
/*!******************************************************!*\
  !*** ./src/app/protected/games/games.component.html ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./src/app/protected/games/games.component.ts":
/*!****************************************************!*\
  !*** ./src/app/protected/games/games.component.ts ***!
  \****************************************************/
...
var GamesComponent = /** @class */ (function () {
    function GamesComponent(store, notifierService, db, router, gameService) {
        var _this = this;
        this.store = store;
        this.notifierService = notifierService;
        this.db = db;
        ...
        this.store.select('auth')
            ...
            if (isAuthinticated) {
                ...
                gamesDbRef.snapshotChanges()
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (changes) { return changes
...
/* harmony import */ var _auth_guard_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth-guard.service */ "./src/app/protected/auth-guard.service.ts");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../auth.service */ "./src/app/auth.service.ts");
/* harmony import */ var _games_games_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./games/games.component */ "./src/app/protected/games/games.component.ts");
/* harmony import */ var _games_game_game_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./games/game/game.component */ "./src/app/protected/games/game/game.component.ts");
/* harmony import */ var _games_games_list_games_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./games/games-list/games-list.component */ "./src/app/protected/games/games-list/games-list.component.ts");
/* harmony import */ var _statistics_statistics_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./statistics/statistics.component */ "./src/app/protected/statistics/statistics.component.ts");
/* harmony import */ var _board_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./board.service */ "./src/app/protected/board.service.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../constants */ "./src/app/constants/index.ts");
...
var protectedRoutes = [
    { path: _constants__WEBPACK_IMPORTED_MODULE_12__["ROUTES"].games, component: _games_games_component__WEBPACK_IMPORTED_MODULE_7__["GamesComponent"], canActivate: [_auth_guard_service__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]], children: [
            { path: _constants__WEBPACK_IMPORTED_MODULE_12__["ROUTES"].root, component: _games_games_list_games_list_component__WEBPACK_IMPORTED_MODULE_9__["GamesListComponent"] },
            { path: _constants__WEBPACK_IMPORTED_MODULE_12__["ROUTES"].game, component: _games_game_game_component__WEBPACK_IMPORTED_MODULE_8__["GameComponent"] },
        ] },
    { path: _constants__WEBPACK_IMPORTED_MODULE_12__["ROUTES"].statistics, component: _statistics_statistics_component__WEBPACK_IMPORTED_MODULE_10__["StatisticsComponent"], canActivate: [_auth_guard_service__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
];
    ...
    ProtectedPagesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _games_game_game_component__WEBPACK_IMPORTED_MODULE_8__["GameComponent"],
                _statistics_statistics_component__WEBPACK_IMPORTED_MODULE_10__["StatisticsComponent"],
                _games_games_list_games_list_component__WEBPACK_IMPORTED_MODULE_9__["GamesListComponent"],
            ],
            imports: [
            ...
            providers: [
                ...
                _board_service__WEBPACK_IMPORTED_MODULE_11__["BoardService"],
            ]
        })
...
var publicRoutes = [
    { path: _constants__WEBPACK_IMPORTED_MODULE_7__["ROUTES"].root, component: _home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"] },
    { path: _constants__WEBPACK_IMPORTED_MODULE_7__["ROUTES"].notFound, component: _not_found_not_found_component__WEBPACK_IMPORTED_MODULE_6__["NotFoundComponent"] },
];
...
/* harmony import */ var _games_games_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./games/games.reducer */ "./src/app/store/games/games.reducer.ts");


var reducers = {
    auth: _auth_auth_reducer__WEBPACK_IMPORTED_MODULE_0__["authReducer"],
    games: _games_games_reducer__WEBPACK_IMPORTED_MODULE_1__["gamesReducer"],
};
...
/***/ "./src/app/store/games/games.actions.ts":
/*!**********************************************!*\
  !*** ./src/app/store/games/games.actions.ts ***!
  \**********************************************/
/*! exports provided: UPDATE, Update */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!**********************************************!*\
  !*** ./src/app/store/games/games.reducer.ts ***!
  \**********************************************/
/*! exports provided: gamesReducer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gamesReducer", function() { return gamesReducer; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _games_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./games.actions */ "./src/app/store/games/games.actions.ts");
...
function gamesReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case (_games_actions__WEBPACK_IMPORTED_MODULE_1__["UPDATE"]):
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { games: action.payload });
        default:
            return state;
    }
}
